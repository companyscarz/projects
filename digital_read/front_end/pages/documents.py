...
async def documents(page, navigate):
...
# ______________________------------------------------logic for dialogue----------------------------_________________________
    ...
    def open_comments_dialog(page, user_id, username, content_id):
        ...
        document_comments = response.get(
            "get_comments", [])  # get documents data
...
# _________________________--------------------logic for sction buttons-------------------------_________________________________
    ...
    def handle_document_action(e, action, info, page, navigate):
        ...
        if action == "COMMENT":
            ...
            try:
                ...
                if response.status_code == 200:
                    ...
                    message.value = "Unfavorited document"
    ...
    try:
                                                ...
                                                ft.Row(
                                                    ...
                                                    controls=[
                                                        like_icon := ft.IconButton(icon=ft.Icons.FAVORITE, icon_size=16,
                                                                                   ...
                                                                                   on_click=lambda e, i=info: handle_document_action(
                                                ...
                                                ft.Row(
                                                    ...
                                                    controls=[
                                                        ft.IconButton(icon=ft.Icons.COMMENT_OUTLINED,
                                                                      tooltip="comments",
                                                                      on_click=lambda e, i=info: handle_document_action(e, "COMMENT", i, page, navigate)),  # opens function that opens a dialogue
        ...
        return ft.View(
            route="/documents",  # route for documents
            controls=[
                top_bar(page, navigate,),  # topbar for digital_read
                details,  # content about digital read documents
                # bottom nav bar
                bottom_bar(page, navigate, active="documents"),
            ]
        )
